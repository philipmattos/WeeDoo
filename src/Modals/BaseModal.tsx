...
export const BaseModal = ({ id, title, children }: BaseModalProps) => {
    ...
    return (
        <div className="fixed inset-0 top-[56px] bottom-[72px] z-20 flex flex-col bg-slate-50 dark:bg-slate-900 sm:max-w-md sm:mx-auto sm:border-x sm:shadow-xl animate-in fade-in slide-in-from-bottom-2 duration-300 ease-out">
            {/* Tab Header */}
